...
public final class OpcodeInfo {
    ...
    public static final Info CONST_METHOD_HANDLE = new Info(Opcodes.CONST_METHOD_HANDLE, "const-method-handle", InstructionCodec.FORMAT_21C, IndexType.METHOD_HANDLE_REF);
    public static final Info CONST_METHOD_TYPE = new Info(Opcodes.CONST_METHOD_TYPE, "const-method-type", InstructionCodec.FORMAT_21C, IndexType.PROTO_REF);
    ...
    public static final Info INVOKE_CUSTOM = new Info(Opcodes.INVOKE_CUSTOM, "invoke-custom", InstructionCodec.FORMAT_35C, IndexType.CALL_SITE_REF);
    public static final Info INVOKE_CUSTOM_RANGE = new Info(Opcodes.INVOKE_CUSTOM_RANGE, "invoke-custom/range", InstructionCodec.FORMAT_3RC, IndexType.CALL_SITE_REF);
    ...
    public static final Info INVOKE_POLYMORPHIC = new Info(Opcodes.INVOKE_POLYMORPHIC, "invoke-polymorphic", InstructionCodec.FORMAT_45CC, IndexType.METHOD_AND_PROTO_REF);
    public static final Info INVOKE_POLYMORPHIC_RANGE = new Info(Opcodes.INVOKE_POLYMORPHIC_RANGE, "invoke-polymorphic/range", InstructionCodec.FORMAT_4RCC, IndexType.METHOD_AND_PROTO_REF);
    ...
    public static final Info SUB_DOUBLE_2ADDR = new Info(Opcodes.SUB_DOUBLE_2ADDR, "sub-double/2addr", InstructionCodec.FORMAT_12X, IndexType.NONE);
