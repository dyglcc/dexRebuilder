...
public final class Opcodes {
    ...
    public static boolean isValidShape(int opcode) {
        ...
        int lowByte = opcode & CONST_METHOD_TYPE;
        if (lowByte == 0 || lowByte == CONST_METHOD_TYPE || (65280 & opcode) == 0) {
            return true;
        }
        return false;
    }
    ...
    public static int extractOpcodeFromUnit(int opcodeUnit) {
        int lowByte = opcodeUnit & CONST_METHOD_TYPE;
        return (lowByte == 0 || lowByte == CONST_METHOD_TYPE) ? opcodeUnit : lowByte;
    }
}
